...
import 'package:sinav/screens/tododetail.dart';
...
class _TodoListModelState extends State<TodoListModel> {
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: const Text("Bittiyse işaretle"),
                    trailing: Row(
  ...
  Future<void> getUptadeAlert() async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Listeyi güncelledin!'),
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Icon(Icons.refresh,
                    color: Color.fromARGB(255, 10, 46, 75), size: 120)
              ],
            ),
          ),
          actions: <Widget>[
